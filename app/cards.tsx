...
const Card = ({ bank, number, type, colors, isSelected, onSelect, isSelectMode }) => (
  ...
  return (
    <View style={styles.container}>
      ...
      {isSelectMode ? (
        ...
        <View style={styles.footerActions}>
          <TouchableOpacity style={[styles.actionButton, styles.addButton]} onPress={() => setShowTemplates(true)}>
